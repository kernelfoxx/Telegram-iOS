...
public class ChatListControllerImpl: TelegramBaseController, ChatListController {
    ...
    override public func loadDisplayNode() {
        ...
        self.chatListDisplayNode.mainContainerNode.openPremiumManagement = { [weak self] in
            ...
            context.sharedContext.openExternalUrl(context: context, urlContext: .generic, url: url, forceExternal: !url.hasPrefix("rg://") && !url.contains("?start="), presentationData: context.sharedContext.currentPresentationData.with({$0}), navigationController: self.navigationController as? NavigationController, dismissInput: {})
        }
